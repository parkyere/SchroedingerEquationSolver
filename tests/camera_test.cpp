// Column-major Mat4 + Vec3d for the renderer. GL-style clip; the Vulkan
// renderer adds its own y-flip/depth-remap.
// Mat4 COLUMN-MAJOR: element(r, c) = m[c*4 + r]; translation at m[12..14].
// View space right-handed, camera looks down -Z. NDC depth [-1, +1].
...
TEST(Mat4, TranslationStorageIsColumnMajor) {
    ...
    EXPECT_EQ(t.m[3], 0.0);  // row-major would store 7 here
}
